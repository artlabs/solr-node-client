...
* @param {String} eg: 'json', 'xml', xslt'
*
* @return {Query}
* @api public
*/

Query.prototype.wt = function(functions) {
    var self = this;
    var parameter = 'wt=' + encodeURIComponent(functions);
    this.parameters.push(parameter);
    return self;
}
...
Query.prototype.setHandler = function(value) {
    var self = this;
    this.handler = value;
    return self;
}
